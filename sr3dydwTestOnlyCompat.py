...
def argumentParser():
    ...
    parser.add_argument('--Scale_Factor', metavar='Scale_Factor', type=str,
                        help='Upsampling factor (Future releases will support more options)')

    parser.add_argument('--Bit_Depth', metavar='Bit_Depth', type=str,
                        help='Bit depth of your input images  (Future releases will support more options)')
    ...
    parser.add_argument('--Use_CPU', metavar='Use_CPU', type=str,
    ...
    parser.add_argument('--Use_GAN', metavar='Use_GAN', type=str,
                        help='Force the network to use the GAN (will default to GAN)')
